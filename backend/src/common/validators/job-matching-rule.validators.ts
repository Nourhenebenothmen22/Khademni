...
export type CreateJobMatchingRuleInput = z.infer<
  typeof createJobMatchingRuleSchema
>;
...
export type UpdateJobMatchingRuleInput = z.infer<
  typeof updateJobMatchingRuleSchema
>;
